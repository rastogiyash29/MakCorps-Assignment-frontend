            ...
            <div className="container">
                <div className="grid-row">
                    <div className="colmun colmun-left">
                        ...
                        <button className="go-home" onClick={()=> {navigate('/')}}><i className="fa fa-home"></i> Go To FORM Page</button>
                        <button className="go-home" onClick={()=> {navigate('/prime')}}><i className="fa fa-home"></i> Go To Prime Numbers Page</button>
                    </div>
